...
个体级与群体级本地矩阵结果来自远程服务器重跑 `/root/autodl-tmp/fusiontrack_b3b8599_val/results`，源码 revision 为 `b3b8599`，日志时间为 2026-05-22。官方论文 baseline 行来自此前官方源码适配运行 `server_artifacts/final_results_20260521/experiment_summary.md`。GPU 环境为 NVIDIA GeForce RTX 5090。指标包括 AUROC、AUPRC、F1、P@100 和 R@100。
